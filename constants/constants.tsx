export const projects = [
  ...
  },
  {
    title: "Trello Clone",
    description:
      "Using Pure HTML, CSS and JS developed an app. The App is called Karlo and it is a simple Task management app that allows users to track their tasks and complete those tasks efficiently.",
  ...
  },
  {
    title: "CHAMP-Keep",
    description:
      "This is a simple web app to take notes. The CHAMP Keep helps user to take notes and store it. It uses Local Storage to store notes",
